...
import { Mail, Phone, MapPin, Send, ChevronLeft, Clock, ExternalLink, CheckCircle } from "react-feather"

const ContactUs = ({ onNavigateToHome }) => {
          ...
          <div className="mx-auto max-w-6xl">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-500 max-w-3xl mx-auto">
                Have questions about LearnSync? We're here to help. Fill out the form below and our team will get back to
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div className="ml-3">
                        ...
                        <a href="mailto:support@learnsync.com" className="text-sm text-gray-500 hover:text-blue-600">
                          support@learnsync.com
                        </a>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div className="ml-3">
                        ...
                        <a href="tel:+1-555-123-4567" className="text-sm text-gray-500 hover:text-blue-600">
                          +1 (555) 123-4567
                        </a>
                      </div>
                    </div>
      ...
      <section className="bg-gray-100 py-12 md:py-16">
        <div className="container mx-auto px-4 md:px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg text-gray-500">Find answers to common questions about LearnSync.</p>
          </div>
          ...
          <div className="mx-auto max-w-3xl mt-12 space-y-6">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <button className="flex justify-between items-center w-full px-6 py-4 text-left">
                <span className="font-medium">How do I get started with LearnSync?</span>
              ...
              <div className="px-6 pb-4">
                <p className="text-gray-500">
                  Getting started is easy! Simply sign up for an account, choose your role (student or teacher), and
                  follow the onboarding process. You'll be able to access all of our AI-powered learning tools right
                  away.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="px-6 pb-4">
                <p className="text-gray-500">
                  We accept all major credit cards, PayPal, and bank transfers. For educational institutions, we also
                  offer purchase orders and invoicing options.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="px-6 pb-4">
                <p className="text-gray-500">
                  Yes! We offer a 14-day free trial for all new users. This gives you full access to all features so you
                  can experience the platform before committing to a subscription.
                </p>
              </div>
            </div>
